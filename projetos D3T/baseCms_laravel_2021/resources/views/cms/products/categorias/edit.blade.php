...
<div class="row">
    <div class="col-md-12">
        <ui-form form-class="form-horizontal" title="Atualizar Registro" token="{{ csrf_token() }}"
            url="{{ route('products_category.update', $product_category->id) }}" cancel-url="{{ route('products_category.index') }}" method="PUT">
            @if($errors->any())
            <div class="col-sm-12">
...
{{--             <div class="row form-group{{ $errors->has('active') ? ' has-error' : '' }}">
            ...
            <div class="row form-group{{ $errors->has('name') ? ' has-error' : '' }}">
                <label class="col-xl-2 col-lg-2 col-sm-2 col-12 text-lg-right text-sm-left">Nome da Categoria</label>
                <div class="col-xl-10 col-lg-10 col-sm-10 col-12">
                    <input class="form-control" aria-label="Nome" type="text" name="name" id="name" value="{{ $product_category->name }}">
                    @if ($errors->has('name'))
                    <span class="help-block">

...
<div class="row">
    <div class="col-md-12">
        <ui-form form-class="form-horizontal" title="Atualizar Registro" token="{{ csrf_token() }}"
            url="{{ route('products.stamp.update', [$id_product, $stamp->id]) }}" cancel-url="{{ route('products.stamp.index', $id_product) }}" method="PUT">
            @if($errors->any())
            <div class="col-sm-12">
...
{{--             <div class="row form-group{{ $errors->has('active') ? ' has-error' : '' }}">
            ...
            <div class="row form-group{{ $errors->has('name') ? ' has-error' : '' }}">
                ...
                <div class="col-xl-10 col-lg-10 col-sm-10 col-12">
                    <input class="form-control" aria-label="Nome" type="text" name="name" id="name" value="{{ $stamp->name }}">
                    @if ($errors->has('name'))
                    <span class="help-block">
...
{{--             <div class="row form-group{{ $errors->has('order') ? ' has-error' : '' }}">
                ...
                <div class="col-xl-10 col-lg-10 col-sm-10 col-12">
                    <input type="number" name="order" aria-label="Nome" class="form-control" id="order"
                        value="{{ $stamp->order }}" maxlength="200" required>
                    @if ($errors->has('order'))
                    <span class="help-block">
...
{{--             <div class="row form-group{{ $errors->has('link') ? ' has-error' : '' }}">
            ...
            <div class="row form-group{{ $errors->has('description') ? ' has-error' : '' }}">
                ...
                <div class="col-xl-10 col-lg-10 col-sm-10 col-12">
                    <textarea name="description" id="teste_newton" value="{{ $product->description }}">{{ $product->description }}
                    </textarea>
            ...
            <div class="row form-group{{ $errors->has('image') ? ' has-error' : '' }}">
                ...
                <div class="col-xl-10 col-lg-10 col-sm-10 col-12">
                    <div class="row">
                        @if (strlen($stamp->image) > 0)

                          <div class="col-md-2 col-xs-4">
                            <img src="{{ asset($stamp->image) }}" style="width:100%">
                          </div>
                        @endif
                        <div class="col-xl-10 col-lg-10 col-sm-10 col-12">
